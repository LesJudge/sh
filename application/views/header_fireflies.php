<div class="header-inner row">
    ...
    <div class="menu-block col-lg-18 col-md-18 col-sm-20 clo-xs-18">
    ...
    <div class="title">
        <img src="<?php echo base_url(); ?>media/logo_fireflies_2.png"  class="stars-img" alt=" " />
        <div class="title-text">            
            <span class="title-fireflies">Fireflies</span>
        </div>
         <div class="title-subtitle">
			<span class="title-sub3"><?php echo $this->data['Lang']['TRAVEL_ENLIGHTENED']; ?>  </span>            
        </div>
